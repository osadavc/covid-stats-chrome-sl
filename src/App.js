...
const App = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-w-[340px] max-w-[310px] min-h-[500px] bg-gray-100 relative">
      {prevCount && (
        <div className="absolute top-10 text-sm">
      ...
      <div className="w-full flex flex-col justify-center items-center">
        <div className="flex justify-center items-center mb-10 bg-gray-200 py-3 px-5 rounded-lg shadow-sm cursor-pointer space-x-2">
          <img
        ...
        <div className="flex justify-center items-center bg-gray-200 py-3 px-6 rounded-lg shadow-sm cursor-pointer space-x-2">
          <img
